            ...
            <ul className="delete-popup" style={{ listStyle: "none" }}>
              <li>
                <form
                  ...
                  action={`http://localhost:5500/deleteComment/${commentId}`}
                ...
                >
                  <div className="comment-modal">
                    <form
                      ...
                      action={`http://localhost:5500/editComment/${commentId}`}
                    >
                      <input
                        required
                        autoFocus
      ...
      <div className="icons">
        <div style={{ color: btnColor }} className="icon">
          <form
            ...
            className="likeForm"
            action={`http://localhost:5500/comment/${props.user}/like/${commentId}`}
            method="post"
          >
            <button>
              <AiOutlineLike />
