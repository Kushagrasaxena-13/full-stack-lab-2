...
function Tweet(props) {
  ...
  async function populateComments() {
    const req = await fetch(`http://localhost:5500/feed/comments/${tweetId}`, {
      headers: {
          ...
          <li className="tweet-items">
            ...
            <div className="parent-flex-introduction">
              <img
                ...
                src={`http://localhost:5500/images/${props.body.postedBy.avatar}`}
              ></img>
                    ...
                    <ul className="delete-popup" style={{ listStyle: "none" }}>
                      <li>
                        <form
                          ...
                          action={`http://localhost:5500/deleteTweet/${tweetId}`}
                          ...
                          {(close) => (
                            <div className="comment-modal">
                              <form
                                ...
                                action={`http://localhost:5500/editTweet/${tweetId}`}
                              >
                                <input
                                  required
                                  autoFocus
            ...
            <div className="icons">
              <div style={{ color: btnColor }} className="icon">
                <form
                  ...
                  className="likeForm"
                  action={`http://localhost:5500/post/${props.user}/like/${tweetId}`}
                  method="post"
                >
                  <button>
                    <AiOutlineLike />
              ...
              {/* <div style={{ color: retweetBtnColor }} className="icon retweet">
                <form
                  ...
                  action={`http://localhost:5500/post/${props.user}/retweet/${tweetId}`}
                >
                  <button>
                    <AiOutlineRetweet />
                ...
                {(close) => (
                  <div className="comment-modal">
                    ...
                    <form
                      ...
                      method="post"
                      action={`http://localhost:5500/feed/comment/${tweetId}`}
                    >
                      <input
                        autoFocus
                        required
